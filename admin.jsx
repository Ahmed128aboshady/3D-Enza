// ============ Enza Trade — owner login + admin dashboard ============
  ...
  return (
    <div className="modal-scrim" onClick={() => setLoginOpen(false)}>
      <form className="modal" onClick={e => e.stopPropagation()} onSubmit={submit}>
        ...
        <img className="modal-emblem" src="logo.png?v=2" alt="" />
...
const blankProduct = () => ({
  ...
  variants: [{ color: { en: 'Default', ar: 'أساسي', hex: '#ed1e26' }, img: '', stock: true, shots: [] }],
  ...
  return (
    <div className="admin">
      <div className="admin-bar">
        <div className="a-logo"><img src="logo.png?v=2" alt="" /> Enza Trade · {L('Admin', 'الإدارة')}</div>
