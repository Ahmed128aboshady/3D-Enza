...
const PRODUCTS = [
  {
    ...
    variants: [
      ...
      { color: C('Orange', 'أورانج/برتقالي', '#ff7f00'), img: 'https://enza-trade-co.odoo.com/web/image/product.product/50/image_1024/PLA%2B%20Filament%20Orange?unique=677d0a9', stock: true, shots: ["https://enza-trade-co.odoo.com/web/image/product.product/50/image_1024/PLA%2B%20Filament%20Orange?unique=677d0a9"] },
      { color: C('Pink', 'وردي/بينك', '#ffc0cb'), img: 'https://enza-trade-co.odoo.com/web/image/product.product/51/image_1024/PLA%2B%20Filament%20Pink?unique=7149510', stock: true, shots: ["https://enza-trade-co.odoo.com/web/image/product.product/51/image_1024/PLA%2B%20Filament%20Pink?unique=7149510"] },
      ...
      { color: C('Mustard Green', 'أخضر خردلي', '#7e7b52'), img: 'https://enza-trade-co.odoo.com/web/image/product.product/55/image_1024/PLA%2B%20Filament%20Mustard%20Green?unique=7ac9de5', stock: true, shots: ["https://enza-trade-co.odoo.com/web/image/product.product/55/image_1024/PLA%2B%20Filament%20Mustard%20Green?unique=7ac9de5"] },
  ...
  },
  {
    ...
    variants: [
      { color: C('Red Blue', 'أحمر وأزرق', 'linear-gradient(135deg, #dc2626 0%, #2563eb 100%)'), img: 'https://enza-trade-co.odoo.com/web/image/product.product/82/image_1024/PLA-Matte%20Filament%20Red%20Blue?unique=3071ab7', stock: true, shots: ["https://enza-trade-co.odoo.com/web/image/product.product/82/image_1024/PLA-Matte%20Filament%20Red%20Blue?unique=3071ab7"] },
    ],
  ...
  },
  {
    ...
    variants: [
      { color: C('Red Green', 'أحمر وأخضر', 'linear-gradient(135deg, #c00000 0%, #145c2f 100%)'), img: 'https://enza-trade-co.odoo.com/web/image/product.product/83/image_1024/PLA-Silk%20Magic%20Filament%20Red%20green?unique=8f80b3e', stock: true, shots: ["https://enza-trade-co.odoo.com/web/image/product.product/83/image_1024/PLA-Silk%20Magic%20Filament%20Red%20green?unique=8f80b3e"] },
      { color: C('Lime Cyan', 'ليموني سماوي', 'linear-gradient(135deg, #bef264 0%, #06b6d4 100%)'), img: 'https://enza-trade-co.odoo.com/web/image/product.product/108/image_1024/PLA-Silk%20Magic%20Filament%20Lime%20CYAN?unique=f8813e3', stock: true, shots: ["https://enza-trade-co.odoo.com/web/image/product.product/108/image_1024/PLA-Silk%20Magic%20Filament%20Lime%20CYAN?unique=f8813e3"] },
    ],
  ...
  },
  {
    ...
    variants: [
      ...
      { color: C('Red', 'أحمر', '#dc2626'), img: 'https://enza-trade-co.odoo.com/web/image/product.product/162/image_1024/eResin-PLA%20Pro%20red?unique=63eb959', stock: true, shots: ["https://enza-trade-co.odoo.com/web/image/product.product/162/image_1024/eResin-PLA%20Pro%20red?unique=63eb959"] },
    ],
  ...
  },
  {
    ...
    variants: [
      { color: C('White', 'أبيض', '#ffffff'), img: 'https://enza-trade-co.odoo.com/web/image/product.product/7/image_1024/PETG%20Filament%20White?unique=7e5b591', stock: true, shots: ["https://enza-trade-co.odoo.com/web/image/product.product/7/image_1024/PETG%20Filament%20White?unique=7e5b591"] },
      { color: C('Black', 'أسود', '#1c1a19'), img: 'https://enza-trade-co.odoo.com/web/image/product.product/53/image_1024/PETG%20Filament%20Black?unique=52d6e59', stock: true, shots: ["https://enza-trade-co.odoo.com/web/image/product.product/53/image_1024/PETG%20Filament%20Black?unique=52d6e59"] },
      { color: C('Grey', 'رمادي', '#808080'), img: 'https://enza-trade-co.odoo.com/web/image/product.product/54/image_1024/PETG%20Filament%20Grey?unique=eedd87f', stock: true, shots: ["https://enza-trade-co.odoo.com/web/image/product.product/54/image_1024/PETG%20Filament%20Grey?unique=eedd87f"] }
    ],
